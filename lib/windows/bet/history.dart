...
import 'package:skiiya_admin/database/price.dart';
    ...
    return Expanded(
      child: Container(
        ...
        child: Selection.user != null
            ...
            !isDetailVisible ? myBetsView(context) : showFullBetDetails()
            :
          ...
          for (var j = 0; j < result.documents.length; j++) {
            ...
            if (_transactionLoader.length > 0) {
              ...
              for (var i = 0; i < _transactionLoader.length; i++) {
                if (_transactionLoader[i]
                        .documentID
                        .toString()
                        .compareTo(result.documents[j].documentID.toString()) ==
                    0) {
          ...
          child: GestureDetector(
            onTap: () {
              setState(() {
                ...
                // Navigator.push(
                //     context, MaterialPageRoute(builder: (_) => skiiya_admin()));
              });
            },
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
