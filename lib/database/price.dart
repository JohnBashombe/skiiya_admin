class Price {
  static double minimumBetPrice = 200;
  static double stake = 0; // minimum betting stake
  static double maxStake = 1000000; // maximum betting stake
  static double maxWinning = 50000000; // maximum winning amount
  // static double balance = 50000;
  static double jackpotMinimumBet = 100;
  static double jackpotWinningAmount = 10000000;
  static double minimumWithdraw = 3000;
  static double maximumWithdraw = 2500000;
  static double maximumDailyWithdraw = 2500000;
  static double minimumDeposit = 2000;
  static double maximumDeposit = 2000000;
